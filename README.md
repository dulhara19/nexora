...
<div style="flex: 1; border: 1px solid #ddd; padding: 10px; border-radius: 5px;">
    <img styles="padding:5px" src="/report/fig7.png" width="40%" alt="nexora screenshots"><img styles="padding:5px" src="/report/fig6.png" width="60%" alt="nexora screenshots">
</div>
...
- **Voice output:** Voice input(currently working) and output for accessibility.
